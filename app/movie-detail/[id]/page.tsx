...
const page = async ({ params }: { params: Promise<{ id: string }> }) => {
  try {
    ...
    const movieCredit = await getMovieCredit(id);
    const movieImagesApi = await getMovieImages(id);
    ...
    return (
      <div className="grid gap-6 text-topic_color px-4">
        ...
        <div className="mt-6  text-center">
          <div className="text-4xl mt-4 font-bold">{data.title}</div>
        ...
        <div className="my-4 grid gap-6">
          <div className="flex flex-col gap-6 sm:flex-row justify-between items-center">
            <div className="flex gap-4 items-center text-sub_topic_color italic">
              <span>{data.release_date}</span> | <span>{data.runtime} min</span>{" "}
          ...
          <div className="grid gap-2">
            ...
            <ReviewImg movieReview={movieReview} />
              ...
              {movieRecommend.results
                ...
                .map((e: any, index: number) => (
                  ...
                  >
                    ...
                    <div className="font-bold px-2 ">{e.title}</div>
                  </Link>
                ))}
            </div>
          </div>
