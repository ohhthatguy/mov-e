    ...
    <div className="min-h-screen bg-primary_color p-8 animate-pulse">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-8">
        ...
        <div className="space-y-6">
          <div className="h-12 w-3/4 bg-gray-700 rounded-lg" /> {/* Title */}
          <div className="flex gap-4">
            <div className="h-6 w-20 bg-gray-700 rounded-full" /> {/* Pill 1 */}
            <div className="h-6 w-20 bg-gray-700 rounded-full" /> {/* Pill 2 */}
          </div>
